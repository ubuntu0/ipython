...
class JuliaMagics0(Magics):
    ...
    def __init__(self, shell):
        ...
        if hasattr(sys, '_julia_initialized'):
            ...
            j = ctypes.CDLL('/home/jeff/src/julia/usr/lib/libjulia-release.so', ctypes.RTLD_GLOBAL)
            j.jl_init("/home/jeff/src/julia/usr/lib")
        ...
        for jname, ctype in unbox_map.iteritems():
            junboxer = getattr(j, 'jl_unbox_' + jname.lower())
